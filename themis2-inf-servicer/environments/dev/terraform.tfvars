...
alb_api_domains = {
  "analyzer"        = "analyzer.unvs-themis.com",       # サービサー①
  "tracker"         = "tracker.unvs-themis.com",        # サービサー①
  "grafana"         = "grafana.unvs-themis.com",        # サービサー①
  "analyzer2"       = "analyzer2.unvs-themis.com",      # サービサー②
  "tracker2"        = "tracker2.unvs-themis.com",       # サービサー②
  "grafana2"        = "grafana2.unvs-themis.com",       # サービサー②
  "transformation"  = "transformation.unvs-themis.com", # サービサー①
  "transformation2" = "transformation2.unvs-themis.com",# サービサー②
  "keycloak2"       = "auth2.unvs-themis.com",          # サービサー①
  "keycloak3"       = "auth3.unvs-themis.com"           # サービサー②
}
