...
resource "aws_vpc" "this" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-vpc-${var.region}"
  }
}
...
resource "aws_subnet" "private_eks_dataplane" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-subnet-private-${var.region}-${var.availability_zones[each.key]}-dataplane"
  }
}
...
resource "aws_subnet" "private_eks_controlplane" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-subnet-private-${var.region}-${var.availability_zones[each.key]}-controlplane"
  }
}
...
resource "aws_subnet" "public_iac" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-subnet-private-${var.region}-${var.availability_zones["subnet1"]}-iac"
  }
}
...
resource "aws_subnet" "public_eks_ingress" {
  ...
  tags = {
    Name                     = "${var.sys_name}-${var.env}-servicer-subnet-public-${var.region}-${var.availability_zones[each.key]}-dataplane"
...
resource "aws_internet_gateway" "this" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-igw"
  }
}
...
resource "aws_eip" "nat_gateway" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-eip-${var.region}-${var.availability_zones[each.key]}"
  }
...
resource "aws_nat_gateway" "public" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-nat-${var.region}-${var.availability_zones[each.key]}"
  }
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-rtb-public"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-rtb-private-${var.region}-${var.availability_zones[each.key]}"
  }
}
...
resource "aws_network_acl" "restricted_vpc_acl" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-restricted-vpc-acl"
  }
}
...
resource "aws_default_network_acl" "this" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-default-acl"
  }
}
