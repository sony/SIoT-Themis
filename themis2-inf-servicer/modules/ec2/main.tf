...
resource "aws_iam_role" "ec2_role" {
  name = "${var.sys_name}-${var.env}-servicer-ec2-admin-role-iac"
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-ec2-role-iac"
  }
}
...
resource "aws_iam_instance_profile" "ec2_profile" {
  name = "${var.sys_name}-${var.env}-servicer-ec2-profile-iac"
  role = aws_iam_role.ec2_role.name
}

resource "aws_key_pair" "this" {
  key_name   = "${var.sys_name}-${var.env}-servicer-keypair-ec2-iac"
...
resource "aws_eip" "this" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-eip-iac"
  }
}

resource "aws_security_group" "this" {
  vpc_id      = var.vpc_id
  name        = "${var.sys_name}-${var.env}-servicer-sg-ec2-iac"
...
resource "aws_instance" "this" {
  ...
  tags = {
    Name = "${var.sys_name}-${var.env}-servicer-ec2-iac"
  }
}
