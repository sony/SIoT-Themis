...
variable "cluster_identifier_sol_prov2" {
  type        = string
...
variable "sample_analyzer2_tg_arn" {
  type        = string
  description = "target group bind arn"
}

variable "sample_tracker2_tg_arn" {
  type        = string
  description = "target group bind arn"
}

variable "grafana2_tg_arn" {
  type        = string
  description = "target group bind arn"
}

variable "transformation2_tg_arn" {
  type        = string
  description = "target group bind arn"
}

variable "keycloak3_tg_arn" {
  type        = string
  description = "target group bind arn"
}

variable "servicer2_console_tg_arn" {
  type        = string
  description = "target group bind arn"
}
