...
variable "kube_proxy_version" {
  type        = string
  default     = null
  description = "kube-proxy のアドオンバージョン。nullの場合はデフォルトバージョンが適用される。"
}

variable "vpc_cni_version" {
  type        = string
  default     = null
  description = "vpc-cni のアドオンバージョン。nullの場合はデフォルトバージョンが適用される。"
}

variable "coredns_version" {
  type        = string
  default     = null
  description = "CoreDNS のアドオンバージョン。nullの場合はデフォルトバージョンが適用される。"
}
